...
public class UpdateReservationForm extends BaseForm {
    ...
    public UpdateReservationForm(Resources res,int id ){
        ...
        setUIID("SignIn");
        TextField event_id = new TextField(String.valueOf(id), "Event_id", 20, TextField.ANY);
        ...
        next.requestFocus();
         next.addActionListener(e -> {
            ...
            rs.modifierReservation(reservation,id);
