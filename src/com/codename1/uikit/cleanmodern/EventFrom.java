...
public class EventFrom  extends BaseForm {
    ...
    public EventFrom(Resources res) {
        ...
        addButton(res.getImage(es.afficheEvent().get(i).getImage()), es.afficheEvent().get(i).getNom_evenement(),es.afficheEvent().get(i).getDescription_evenement(), true,es.afficheEvent().get(i).getNbr_de_places() ,es.afficheEvent().get(i).getLieu_evenement(),btn,es.afficheEvent().get(i).getId(),res,i);
    }
    }
